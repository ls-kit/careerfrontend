...
const menus = [
  {
    id: 1,
    link: (
      <Link className="text-white text-sm" to="/home">
        Home
      </Link>
    ),
  },
  {
    id: 2,
    link: (
      <Link className="text-white text-sm" to="/about-BCO">
        About BCO
      </Link>
    ),
  },
  {
    id: 3,
    link: (
      <Link className="text-white text-sm" to="/central-comitee">
        Central Comitee
      </Link>
    ),
  },
  {
    id: 4,
    link: (
      <Link className="text-white text-sm" to="/organizer">
        organizer
      </Link>
    ),
  },
  {
    id: 5,
    link: (
      <Link className="text-white text-sm" to="/news-media">
        News-Media
      </Link>
    ),
  },
  {
    id: 6,
    link: (
      <Link className="text-white text-sm" to="/contact-us">
        Contact Us
      </Link>
    ),
  },
  {
    id: 7,
    link: (
      <Link className="text-white text-sm" to="/Courses">
        Courses
      </Link>
    ),
  },
  {
    id: 8,
    link: (
      <Link className="text-white text-sm" to="/Blog">
        Blog
      </Link>
    ),
  },
  {
    id: 9,
    link: (
      <Link className="text-white text-sm" to="/FAQ">
        FAQ
      </Link>
    ),
  },
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <Link
                className="bg-green-500 py-2 px-4 font-medium text-white text-sm rounded-sm ml-3"
                to="/login"
              >
                Login
              </Link>
      ...
      <div className="bg-black lg:hidden mx-auto px-4 flex items-center justify-between">
        ...
        <div>
          <button
            ...
            className="text-4xl flex items-center justify-center  text-white"
          >
            <AiOutlineMenu />
          </button>
        </div>
      ...
      >
        <div className=" px-4 pt-8 w-[300px] top-0 h-screen bg-black">
          ...
          <div>
            ...
            <Link className="text-white text-sm" to="/login">
