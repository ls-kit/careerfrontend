...
const Footer = () => {
    return (
        <div>
            ...
            <div className='bg-black text-center text-white text-base py-5'>
                All rights reserved by : <a className='text-blue-600' href="/">Bangladesh Career Olympiad 2022</a>
            </div>
        </div>
    );
};
